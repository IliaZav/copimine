...
Require-Contains $economy 'artifact_purchase_limit_resets' 'EconomyCore duplicate-entitlement guard must respect an administrator purchase-limit reset.'
Require-Contains $economy 'created_at > 100000000000' 'EconomyCore duplicate-entitlement guard must normalize millisecond and second timestamps around a reset.'
