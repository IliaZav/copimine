...
REQUIRED_SOURCE_FILES = [
    ...
    "assets/copimine/sounds/end_rift/intermission_4.ogg",
    "assets/copimine/sounds/end_rift/boss_cinematic.ogg",
    "assets/copimine/sounds/end_rift/final_drain.ogg",
    "assets/copimine/sounds/end_rift/final_ritual.ogg",
    "assets/copimine/sounds/end_rift/final_wave.ogg",
