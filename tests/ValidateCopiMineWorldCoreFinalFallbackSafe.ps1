...
Require-Contains $worldCore 'retryRedirectTeleport' 'A cancelled redirect teleport must get one safe next-tick retry.'
Require-Contains $worldCore 'retryScheduled' 'WorldCore must keep the redirect guard active while the retry is pending.'
