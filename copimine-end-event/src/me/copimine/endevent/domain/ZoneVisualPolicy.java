...
public final class ZoneVisualPolicy {
    ...
    private static Map<ZoneState, Profile> buildProfiles() {
        ...
        profiles.put(ZoneState.CHARGING, new Profile("charging", "minecraft:reverse_portal", "minecraft:end_rod", 0xD56CFF, 0.06D, 72, 30));
        profiles.put(ZoneState.DANGER, new Profile("danger", "minecraft:smoke", "minecraft:flame", 0xE85B3D, 0.07D, 60, 30));
        profiles.put(ZoneState.SAFE, new Profile("safe", "minecraft:happy_villager", "minecraft:dust_color_transition", 0x54FF69, 0.08D, 68, 18));
