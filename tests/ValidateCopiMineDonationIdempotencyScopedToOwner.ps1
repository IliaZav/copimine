...
Require-Contains $mainPy 'SELECT id,player_uuid,player_name,provider,amount,amount_rub,donation_units,status,qr_payload,' 'admin-web donation session idempotency replay must read the session owner before provider-specific payment fields.'
