...
if (($backend -notmatch 'deop \{username\}' -and $backend -notmatch 'deop \{minecraft_name\}') -or $backend -notmatch 'parent remove admin' -or $backend -notmatch 'parent remove junior_admin') { throw 'Demotion is missing OP/LuckPerms revocation.' }
