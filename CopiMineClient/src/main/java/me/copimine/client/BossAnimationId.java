...
/**
 * Canonical client-side counterpart of the server End Rift animation catalogue.
 * Artist aliases are case-insensitive: Running2, Swipe2, Hurt2, Dying2,
 * udar_iz_grudi and udar_po_zemle2.
 */
