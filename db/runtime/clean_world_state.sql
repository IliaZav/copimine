...
DECLARE
    ...
    reset_tables TEXT[] := ARRAY[
        ...
        'cmv7_ar_economy_snapshots','cmv7_ar_events','cmv7_ar_guard_incidents',
        'cmv7_ar_placed_blocks','cmv7_ar_scan_reports','cmv7_ar_transactions',
        'cmv7_audit','cmv7_ballot_issues','cmv7_election_curators',
        'cmv7_election_settings','cmv7_inventory_snapshots',
        'cmv7_official_item_bindings','cmv7_player_activity','cmv7_player_checks',
        'cmv7_polling_stations','cmv7_president_cooldowns','cmv7_president_state',
        'cmv8_startup_checks','election_sessions','election_visual_cleanup_queue','election_application_reviews',
