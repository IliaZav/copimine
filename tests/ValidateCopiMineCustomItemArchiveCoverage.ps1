...
if ($ids.Count -ne 20 -or @($ids | Select-Object -Unique).Count -ne 20) { $errors.Add('Texture source mapping must contain 20 unique custom-textured catalog ids including the AR infinite totem; the vanilla shield is intentionally excluded.') }
