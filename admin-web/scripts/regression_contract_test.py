...
def main() -> None:
    ...
    require(interact_handler, "var1.getBlockFace() != BlockFace.UP", "Wind Hammer ground interaction")
    ...
    require(wind_hammer, "setVelocity(player.getVelocity().setY(1.9D))", "Wind Hammer launch")
    require(wind_hammer, "setFreezeTicks(Math.max(living.getFreezeTicks(), 100))", "Wind Hammer freeze")
    require(wind_hammer, "PotionEffectType.SLOWNESS, 100, 10", "Wind Hammer freeze")
