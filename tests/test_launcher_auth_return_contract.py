...
def test_binding_fix_is_cache_busted_on_auth_and_link_pages():
    assert 'from "./auth/auth-page.js?v=20260825siteui8"' in BOOTSTRAP
    assert 'from "./shared/app-routes.js?v=20260825siteui8"' in BOOTSTRAP
    for relative in ("signin.html", "register.html", "cabinet/link.html"):
        ...
        assert '/assets/app.js?v=20260825siteui8' in html
