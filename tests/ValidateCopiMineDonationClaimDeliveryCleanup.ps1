...
Require-Regex $artifacts 'failDonationDeliveryAsync\([^;]*\)(?:\.whenComplete|\s*;)' 'Artifacts must move ambiguous donation deliveries to DELIVERY_REVIEW/invalid cleanup flow instead of silently retrying.'
