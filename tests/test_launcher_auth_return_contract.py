...
def test_binding_fix_is_cache_busted_on_auth_and_link_pages():
    ...
    for relative in ("signin.html", "register.html"):
        ...
        assert '/assets/app.js?v=20260901motion1' in html
...
def test_launcher_link_runtime_cache_key_changes_when_binding_flow_changes():
    ...
    assert 'app.js?v=20260901motion1' in link
    assert 'js/bootstrap.js?v=20260901motion1' in app
    assert 'cabinet-runtime.js?v=20260901motion1' in bootstrap
