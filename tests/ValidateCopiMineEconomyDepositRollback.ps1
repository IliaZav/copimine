...
Require-Contains $text 'private String depositArFromHandAsync(Player player, String atmId) throws Exception {' 'EconomyCore must have async hand deposit wrapper.'
Require-Contains $text 'private String depositAllArAsync(Player player, String atmId) throws Exception {' 'EconomyCore must have async full inventory deposit wrapper.'
