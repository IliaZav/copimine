...
Require-Contains $text 'restoreOfficialArSafely(player, snapshot' 'Full inventory deposit must restore only the captured official AR on failed credit.'
Require-Contains $text 'removeOfficialArSerial' 'Deposit rollback must remove only the exact captured official AR serials.'
