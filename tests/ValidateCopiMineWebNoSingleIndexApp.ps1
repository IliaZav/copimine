...
Require-Regex $index '<script type="module" src="/assets/js/public/public-page\.js(?:\?v=[^"]+)?"></script>' 'index.html must load the lightweight public entrypoint.'
...
Require-Regex $signin '<script type="module" src="/assets/app\.js(?:\?v=[^"]+)?"></script>' 'signin.html must load the modular authenticated frontend entrypoint.'
