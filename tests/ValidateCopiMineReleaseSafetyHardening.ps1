...
Require-Contains $prepareEmotecraftSh 'fabric-api-0.116.12+1.21.1.jar' 'Shell Fabric API preparer must use the packaged Fabric API version.'
Require-Contains $prepareEmotecraftPs1 'fabric-api-0.116.12+1.21.1.jar' 'PowerShell Fabric API preparer must use the packaged Fabric API version.'
Require-NotContains $prepareEmotecraftSh '0.116.11' 'Shell Fabric API preparer must not stage an older version.'
Require-NotContains $prepareEmotecraftPs1 '0.116.11' 'PowerShell Fabric API preparer must not stage an older version.'
