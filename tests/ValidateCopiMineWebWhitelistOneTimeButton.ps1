...
Require-Contains $appJs 'data-click="playerRequestWhitelist()"' 'Frontend cabinet must render a one-time whitelist request button via delegated click handling.'
