...
- `AuthEffects` переписан на корректные AuthMe events: эффект до авторизации, очистка после `/login` и `/register`, очистка сессии на выходе, отмена задач на disable.
