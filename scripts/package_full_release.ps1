...
$generatedReleaseFiles = @(
    ...
    'minecraft\server\plugins\FarmControl\config.yml',
    'minecraft\server\plugins\ClearLag\config.yml',
    'minecraft\server\plugins\ClearLag\messages.yml',
...
$serverReleaseJars = @(
    ...
    'minecraft\server\plugins\ClearLag.jar',
    ...
    'minecraft\server\plugins\EssentialsX-2.22.0.jar',
    'minecraft\server\plugins\EssentialsXChat-2.22.0.jar',
