...
foreach ($marker in @('enabled: true','mode: AUTO','allow_client_mod_visuals: true','allow_server_resource_pack_overlay: true','allow_server_particle_fallback: true','!configService.visualsEnabled()','case SERVER_FALLBACK ->')) {
