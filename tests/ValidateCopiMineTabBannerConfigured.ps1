...
$bannerTexturePath = Join-Path $root 'resourcepacks\src\assets\copimine\textures\gui\tab\copimine_logo.png'
...
if ($fontConfig -notmatch 'copimine:gui/tab/copimine_logo.png') { throw 'Resource-pack font does not point TAB glyph to copimine_logo.png.' }
