...
/** Exact, bounded Wave 4 obelisk and pressure scaling for V3. */
public final class V3ObeliskScalingPolicy {
    public static final int MIN_PLAYERS = 2;
    public static final int MAX_PLAYERS = 20;
    public static final int MAX_OBELISKS = 6;

    private V3ObeliskScalingPolicy() {
    }
    ...
    public record Profile(int obeliskCount, int health, int requiredHits,
        ...
        public Profile {
            if (obeliskCount < 0 || obeliskCount > MAX_OBELISKS
                ...
                throw new IllegalArgumentException("invalid V3 obelisk profile");
            }
