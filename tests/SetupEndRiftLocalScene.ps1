...
foreach ($command in @(
  ...
  "execute in $world run setblock $spawnStationX1 $spawnStationY $spawnButtonZ minecraft:stone_button[face=floor,facing=south,powered=false]",
  "execute in $world run setblock $spawnStationX2 $spawnStationY $spawnButtonZ minecraft:stone_button[face=floor,facing=south,powered=false]",
